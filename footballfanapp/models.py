...
class footballclub(models.Model):
    ...
    logo=models.ImageField(null=True, blank=True, default='default_logo.png')
    ...
    manager_pic=models.ImageField(null=True, blank=True, default='default_manager_pic.png')
